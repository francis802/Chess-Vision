...
if __name__ == "__main__":
    ...
    # === Save metrics
    os.makedirs("metrics/board_mask_maskrcnn", exist_ok=True)
    np.save("metrics/board_mask_maskrcnn/train_losses.npy", np.array(train_losses))
    np.save("metrics/board_mask_maskrcnn/val_losses.npy", np.array(val_losses))
    np.save("metrics/board_mask_maskrcnn/val_ious.npy", np.array(val_ious))

    print("✅ Metrics saved to 'metrics/board_mask_maskrcnn' folder.")
